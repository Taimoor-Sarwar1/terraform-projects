...
4. Nginx installed on the EC2.
5. A record in the Route53 from xyz.com to the public IP of our EC2 instance.
...
4. Security Group: Having 0.0.0.0/0 allowing incoming requests to SSH port and outbound rule that allows all traffic to 0.0.0.0/0.
